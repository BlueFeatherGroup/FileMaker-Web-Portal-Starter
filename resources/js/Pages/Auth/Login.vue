        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 flex flex-col justify-center text-center">
                ...
                <inertia-link v-if="canResetPassword" :href="route('password.request')"
                              class="underline mt-4 text-sm text-gray-600 hover:text-gray-900">
                    Forgot your password?
                </inertia-link>
            </div>
            <div class="border-t border-gray-300 border-solid mx-10 my-10"></div>
            <div class="flex items-center justify-center mb-5">

                <button-link v-if="canResetPassword" :href="route('register')"
                             class="">
                    Create Account
                </button-link>
            </div>

            ...
            <div class="max-w-xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <form-card @submitted="submitPayment" class="">
                    ...
                    <template #form>
                        ...
                        <div v-if="step === 1">
                            <div class="mt-4 text-gray-800 font-medium">Pay Invoice #{{ invoiceNumber }}</div>
                            <div class="mt-4">Invoice Amount: {{formatCurrency(total)}}</div>
                            <div v-if="total !== outstandingBalance" class="text-gray-500 text-sm">Outstanding Balance:
...
export default {
    ...
    data() {
        return {
            ...
            paymentAmount: parseFloat(this.outstandingBalance),
            step: 1,
        };
    },
    methods: {
